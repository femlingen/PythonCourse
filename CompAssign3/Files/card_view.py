...
hand = HandModel() # generate a random hand for p2
hand2 = HandModel() # generate a random hand for p2

card_view_p1 = CardView(hand)
card_view_p2 = CardView(hand2)

# Creating a small demo window to work with, and put the card_view inside:
box = QVBoxLayout()
box.addWidget(card_view_p1)
box.addWidget(card_view_p2)
